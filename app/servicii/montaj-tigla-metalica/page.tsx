...
export const metadata: Metadata = {
  title: "Montaj Țiglă Metalică | Preț Corect & Garanție | Noi Te Acoperim",
  description:
    "Montaj profesional țiglă metalică. Materiale premium, echipă cu experiență, garanție 10 ani. Evaluare și ofertă gratuită!",
  keywords:
    "montaj tigla metalica, tigla metalica pret, acoperis tigla metalica",
};
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative container mx-auto px-4 py-20 text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto text-balance">
            Soluția perfectă pentru un acoperiș modern, durabil și estetic.
            Garanție 10+ ani!
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Avantajele Țiglei Metalice
            </h2>
            <p className="text-lg text-muted-foreground">
              De ce să alegi țigla metalică?
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Rezistență de peste 50 de ani cu întreținere minimă",
              },
              {
              ...
              },
              {
                ...
                description:
                  "Suportă vânt puternic, grindină, zăpadă abundentă",
              },
              {
                title: "Varietate de Culori",
                description:
                  "Peste 20 de culori disponibile pentru orice stil arhitectural",
              },
              {
                title: "Montaj Rapid",
      ...
      <section className="py-20 bg-muted/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Tipuri de Țiglă Metalică
            </h2>
            <p className="text-lg text-muted-foreground">
              Soluții pentru orice buget și stil
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <Card
                key={index}
                className={`card-3d shadow-3d hover:shadow-3d-hover border-2 transition-all duration-500 ${
                  type.popular ? "border-secondary" : "hover:border-primary/20"
                }`}
              >
                <CardContent className="p-6">
                  {type.popular && (
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Execuție profesională în 5 pași
            </p>
          </div>
            ...
            {[
              {
                step: "01",
                title: "Evaluare",
                desc: "Măsurători și evaluare gratuită",
              },
              {
                step: "02",
                title: "Pregătire",
                desc: "Pregătirea suprafeței și șarpantei",
              },
              {
                step: "03",
                title: "Montaj",
                desc: "Instalarea țiglei metalice",
              },
              {
                step: "04",
                title: "Finisare",
                desc: "Montaj accesorii și finisări",
              },
              {
                step: "05",
                title: "Verificare",
                desc: "Control calitate și curățenie",
              },
            ].map((item, index) => (
              <div
                key={index}
      ...
      <section className="py-20 bg-gradient-to-br from-primary to-primary/80 text-primary-foreground relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
            Contactează-ne astăzi pentru evaluare gratuită și ofertă
            personalizată
          </p>
          <Button
            size="lg"
            variant="secondary"
            asChild
            className="text-lg h-14 px-8 shadow-3d-hover"
          >
            <a href="tel:0734591048">
              <Phone className="mr-2 h-5 w-5" />
